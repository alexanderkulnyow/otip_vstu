...
function dds_loadmore_button( $category ) {
	global $wp_query;
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
        ...
        <button class="dds_loadmore" id="dds_loadmore-<?php echo $category; ?>" class="center-block pr-5 pl-5">Загрузить
            ещё
        </button>
	<?php endif;
